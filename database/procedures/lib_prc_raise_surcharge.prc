CREATE OR REPLACE PROCEDURE lib_prc_raise_surcharge ( p_user_id NUMBER
                                                     ,p_amount  NUMBER )
IS
  co_procedure CONSTANT VARCHAR2(30) := 'lib_prc_raise_surcharge';
	v_debug               NUMBER;
	v_surcharge           NUMBER;
